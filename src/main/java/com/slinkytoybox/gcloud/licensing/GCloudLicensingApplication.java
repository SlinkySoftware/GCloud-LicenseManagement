/*
 *   gcloudlicensing - GCloudLicensingApplication.java
 *
 ...
 *
 */
package com.slinkytoybox.gcloud.licensing;
...
@Slf4j
public class GCloudLicensingApplication {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(GCloudLicensingApplication.class, args);
    ...
    public void setLogo(String consoleLogo) {
        synchronized (logoLock) {
            GCloudLicensingApplication.consoleLogo = consoleLogo;
        }
